...
from database import get_backlink, list_backlinks, record_generation
from generators.content_generator import count_html_words, generate_tier2_content, revise_existing_content, suggest_content_tags
...
def _backlink_context(state: dict) -> dict:
    ...
    return {
        ...
        "backlink_tier_level": selected.get("tier_level", "Tier 2") or "Tier 2",
...
def _prepare_quality_and_tags(state: dict):
    selected = state["selected_backlink"] or {}
